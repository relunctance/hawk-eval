...
### 2026-04-24：5 条快速验证（开发迭代用）

**用途**：每次代码改动后快速验证，不需要跑全量 200 条。

**验证集**：conversational_qa 前 5 条（中文）
...
> commit: `9a4d152`，评测日期：2026-04-24

**命令**：`make benchmark-hawk`（默认跑 5 条快速验证）

---

### 2026-04-24：25 条验证（memory_id 精确匹配 vs text 匹配）
